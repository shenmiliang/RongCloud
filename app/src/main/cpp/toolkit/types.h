#ifndef DEEP_TOOLKIT_TYPES_H
#define DEEP_TOOLKIT_TYPES_H
...
namespace toolkit
{
  ...
  namespace types
  {
    ...
    // specific alias.
    template class DEEP_TOOLKIT_EXPORTS BoundingBoxType<int, float>;

    template class DEEP_TOOLKIT_EXPORTS BoundingBoxType<float, float>;

    template class DEEP_TOOLKIT_EXPORTS BoundingBoxType<double, double>;

    typedef BoundingBoxType<int, float> Boxi;
    typedef BoundingBoxType<float, float> Boxf;
    typedef BoundingBoxType<double, double> Boxd;

    typedef struct DEEP_TOOLKIT_EXPORTS LandmarksType
    {
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS BoxfWithLandmarksType
    {
      Boxf box;
      Landmarks landmarks;
      bool flag;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS EulerAnglesType
    {
      float yaw;
      float pitch;
      float roll;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS EmotionsType
    {
      float score;
      unsigned int label;
      const char *text;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS AgeType
    {
      float age;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS GenderType
    {
      float score;
      unsigned int label;
      const char *text;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS OCRContentType
    {
      const char *text;
      unsigned int *codecs;
      bool flag;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS FaceContentType
    {
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS StyleContentType
    {
      cv::Mat mat;
      bool flag;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS SuperResolutionContentType
    {
      cv::Mat mat;
      bool flag;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS ColorizeContentType
    {
      cv::Mat mat;
      bool flag;
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS ImageNetContentType
    {
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS SegmentContentType
    {
    ...
    typedef struct DEEP_TOOLKIT_EXPORTS MattingContentType
    {
...
inline toolkit::types::BoundingBoxType<O1, O2>
toolkit::types::BoundingBoxType<T1, T2>::convert_type() const
{
...
template <typename T1, typename T2>
template <typename O1, typename O2>
inline typename toolkit::types::BoundingBoxType<T1, T2>::value_type
toolkit::types::BoundingBoxType<T1, T2>::iou_of(const BoundingBoxType<O1, O2> &other) const
{
...
template <typename T1, typename T2>
inline ::cv::Rect toolkit::types::BoundingBoxType<T1, T2>::rect() const
{
  types::__assert_type<value_type, score_type>();
...
template <typename T1, typename T2>
inline ::cv::Point2i toolkit::types::BoundingBoxType<T1, T2>::tl() const
{
  types::__assert_type<value_type, score_type>();
  auto boxi = this->template convert_type<int>();
...
template <typename T1, typename T2>
inline ::cv::Point2i toolkit::types::BoundingBoxType<T1, T2>::rb() const
{
  types::__assert_type<value_type, score_type>();
  auto boxi = this->template convert_type<int>();
...
template <typename T1, typename T2>
inline typename toolkit::types::BoundingBoxType<T1, T2>::value_type
toolkit::types::BoundingBoxType<T1, T2>::width() const
{
  types::__assert_type<value_type, score_type>();
...
template <typename T1, typename T2>
inline typename toolkit::types::BoundingBoxType<T1, T2>::value_type
toolkit::types::BoundingBoxType<T1, T2>::height() const
{
  types::__assert_type<value_type, score_type>();
...
template <typename T1, typename T2>
inline typename toolkit::types::BoundingBoxType<T1, T2>::value_type
toolkit::types::BoundingBoxType<T1, T2>::area() const
{
  types::__assert_type<value_type, score_type>();
